...
import 'apis/api_filmes.dart';

// Configure routes.
final _router = Router()
  ..get('/', _rootHandler)
  ..post('/filmes/gravar', gravarFilmes)
  ..post('/filmes/deletar', deletarFilmes)
  ..post('/filmes/pesquisar', pesquisarFilmes);
